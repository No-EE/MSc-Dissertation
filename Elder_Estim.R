...
postResample(pred = rf_pred_test, obs = est$elder)
MAPE(est$rf_pred_test,est$elder)
cor(est$rf_pred_test,est$elder, method = c("pearson"))
...
##calculate the measures for validation
postResample(pred = svm_pred_test, obs = est$elder)
MAPE(est$svm_pred_test,est$elder)
cor(est$svm_pred_test,est$elder, method = c("pearson"))
...
MAPE(est$lm_pred_test,est$elder)
cor(est$lm_pred_test,est$elder, method = c("pearson"))
...
summary(results)
dotplot(results, main="RF with different amount of trees (Elderly)")
